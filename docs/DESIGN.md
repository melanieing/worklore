...
| 파일 | 용도 | 규격 |
|---|---|---|
| `src/app/icon.svg` | 파비콘 (벡터 원본, Next 자동 서빙) | 512 viewBox |
| `public/brand/worklore_app_icon.png` | 앱 아이콘 고해상 (스토어/PWA 소스) | 1254×1254 |
| `public/brand/worklore_wordmark.png` | 워드마크 (랜딩/이메일 헤더) | 1774×887 |
| `public/brand/worklore_og.png` | OG/소셜 공유 (layout.tsx 메타 연결됨) | 1200×630 |

- OG 이미지는 `NEXT_PUBLIC_SITE_URL` 기준 절대 URL로 서빙 (배포 시 env 설정 필요).
